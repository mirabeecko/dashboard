      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <p className="mb-6 text-center text-gray-500">
            Dashboard pro sledování výkonu webů. Přihlaste se svým Google účtem pro přístup k GA4 datům.
          </p>
          <button
            onClick={() => signIn('google')}
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-gray-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-gray-800"
          >
